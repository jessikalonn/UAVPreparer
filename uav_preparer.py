...
class UAVPreparer:
    ...
    def run(self):
        ...
        # access the vector layer and attribute table
        ...
        # set up for help button
        self.dlg.helpButton.clicked.connect(self.help)

        # set up for run button
    ...
    def savefile(self):
        ...
        self.dlg.textout.setText(self.outputfile[0])
    
    def help(self):
        url = 'https://github.com/jessikalonn/UAVPreparer'
    ...
    def start_progress(self):
        ...
        r = 100                                             # Choose how big cliped raster should be

        numfeat = vlayer.featureCount()
        result = np.zeros([numfeat, 4])

        # load big raster file which we will clip
        bigraster = gdal.Open(filepath_dsm)
        filepath_tempdsm = self.plugin_dir + '/clipdsm.tif'

        self.dlg.progressBar.setRange(0, numfeat)           # How many step the progressbar should be in
        i = 0                                               # Start counter
        ...
        np.savetxt(self.outputfile[0], result, fmt=numformat, header=headertext)

        # Message if the operation was sucessfull
        self.iface.messageBar().pushMessage('UAV Preparer. Operation Sucessful!', level=Qgis.Success, duration=5)